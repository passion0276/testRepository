...
<body>
    ...
    <section id="search">
        <form action="" method="post">
            ...
            <div class="form-row">
                <div class="col">
                    <label class="col-form-label-sm">從</label>
                    <input type="text" class="form-control" placeholder="出發地(城市/機場)">
                </div>
                <div class="col">
                    <label class="col-form-label-sm">到</label>
                    <input type="text" class="form-control" placeholder="目的地(城市/機場)">
                </div>
                <div class="col">
                    <label class="col-form-label-sm">去程</label>
                    <input type="date" class="form-control" placeholder="去程日">
                </div>
                <div class="col">
                    <label class="col-form-label-sm">回程</label>
                    <input type="date" class="form-control" placeholder="回程日">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-1">
                    <label for="adultA" class="col-form-label-sm">成人</label>
                    <select id="adultA" class="form-control">
                ...
                <div class="form-group col-md-1">
                    <label for="childA" class="col-form-label-sm">兒童</label>
                    <select id="childA" class="form-control">
                            <option selected>0</option>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100" src="../images/flight/firstpage_wall1.jpg" alt="First slide">
                ...
                <div class="carousel-item">
                    <img class="d-block w-100" src="../images/flight/firstpage_wall2.jpg" alt="Second slide">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>高雄小港國際機場</h5>
                ...
                <div class="carousel-item">
                    <img class="d-block w-100" src="../images/flight/firstpage_wall3.jpg" alt="Third slide">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>臺北松山國際機場</h5>
                ...
                <div class="carousel-item">
                    <img class="d-block w-100" src="../images/flight/firstpage_wall4.jpg" alt="Third slide">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>花蓮機場</h5>
                ...
                <div class="carousel-item">
                    <img class="d-block w-100" src="../images/flight/firstpage_wall5.jpg" alt="Tainan Airport">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>臺南國際機場</h5>
