...
<link href="../css/style.css" rel="stylesheet" />
    ...
    <script>
        $(function() {
            ...
            $('.login .fa .fa-times').click(function(){
...
<body>
    ...
    <nav>
        ...
        <ul>
            ...
            <li><a href="ticket_index.jsp">搜尋門票</a><span class="line"></span></li>
            ...
            <div id="show">
                <div class="tourbox">
                    ...
                    <div>
                        ...
                        <p>台北市大安區和平東路四段59號1樓</p>
                        <p>簡介簡介簡介簡介簡介簡介簡介簡介簡介簡介簡介簡介簡介簡介簡介簡介簡介簡介簡介簡介簡介
                           簡介簡介簡介簡介簡介簡介簡介簡介簡介簡介簡介簡介簡介簡介簡介簡介簡介簡介簡介簡介簡介簡介簡介簡介簡介
                        </p>
                        <div class="btnT">
                        	<p><span>500</span>元</p>
                            <div class="info"><a href="ticket_order.jsp">購買</a></div>
                        </div>
                    </div>
                </div>
            </div>
