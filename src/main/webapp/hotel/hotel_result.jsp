            ...
            <div id="show">
                <div class="hotelbox">
                    ...
                    <div>
                        <h4>西門星辰大飯店(西門店)</h4>
                        <p>台北市板橋區府中路67號</p>
                        <p>8層樓的建築裡提供83間別緻客房，舒適的布置讓人有如家般的體驗。現代化的貼心設施，如平面電視, 清潔用品, 開放式衣櫥, 免費即溶咖啡, 免費茶包，在特定的房型中提供，旅客可根據需求選擇最合適的房型。住宿位置優越讓旅客前往市區內的熱門景點變得方便快捷。</p>
                        <div class="btnH">
                            <div class="info"><a href="hotel_roomInfo.jsp">查看房型</a></div>
                        </div>
                    </div>
                </div>
                <div class="hotelbox">
