            ...
            <div class="keybox">
                ...
                <div class="container mt-3">
                  <div class="row justify-content-between">
                    <div>
                     <a href="hotel_order.jsp"><button class="btn btn-primary btn-secondary">上一步：填寫資料</button></a>
                    </div>
                    <div>
                     <a href="hotel_ordercommit.jsp"><button class="btn btn-primary btn-warning">下一步：付款</button></a>
                    </div>
                  </div>
                </div>
