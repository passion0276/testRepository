...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.1/js/bootstrap.min.js" integrity="sha384-smHYKdLADwkXOn1EmN1qk/HfnUcbVRZyYmZ4qpPea6sjB/pTJ0euyQp0Mk8ck+5T" crossorigin="anonymous"></script>
    <script>
        $(function() {
            ...
            $('.where ul li:nth-child(3) a').css({"font-weight":"bold", 
                                                  "background-color": "#e2772b"});
        ...
        <div id="main">
            <div id="show">
                    ...
                    <div>
                        ...
                        <div>
                            <form class="permission_form">
                                <select id="permission" class="form-control-sm">
                                    <option value="personal">私人</option>
                                    <option value="all">公開</option>
                                </select>
                            </form>
                ...
                <div class="tourbox">
                    ...
                    <div>
                        <h4><span class="tag food">美食</span>環島遊‧台北+花蓮 (南部出發)</h4>
                        <p><span>3</span>天/預算<span>5,000</span>元</p>
                        <p>台北101→九份老街→野柳地質公園→宜蘭羅東夜市→花蓮海洋公園</p>
                        <div>
                            <form class="permission_form">
