...
<body>
    ...
    <nav>
        ...
        <ul>
            ...
            <li><a href="traffic_index.jsp">搜尋車票</a><span class="line"></span></li>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-1 mr-3">
                    <label for="orderOp" class="col-form-label-sm">車段</label>
                ...
                <div class="col-1">
                    <label for="orderOp" class="col-form-label-sm">人數</label>
                    <select id="orderbyOp" class="form-control">
            ...
            <div class="accordion" id="accordionExample">
                ...
                <div class="card">
                    <div class="card-header" id="transferFeq">
                        <h5 class="mb-0">
                            <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">車種
                            </button>
                        </h5>
                    </div>
                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="transferFeq" data-parent="#accordionExample">
                        <div class="card-body">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="direct">自強號</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="turn1">
                                <label class="form-check-label" for="turn1">莒光號</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="turn1">
                                <label class="form-check-label" for="turn1">區間車</label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header" id="startTime">
                        <h5 class="mb-0">
                            <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">出發/抵達時間</button>
                        </h5>
                    </div>
                    <div id="collapseTwo" class="collapse" aria-labelledby="startTime" data-parent="#accordionExample">
                        <div class="card-body">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="start" value="start">
                                <label class="form-check-label" for="start">出發時間</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="back" value="back">
                                <label class="form-check-label" for="back">抵達時間</label>
                            </div>
                            <div id="time-range">
                                <p>去程:
            ...
            <div id="show">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>10:34</td>
                        <td>01時19分</td>
                        <td>150元<a href="traffic_order.jsp">購買</a></td>
                    </tr>
                    <tr>
                        <td>1251</td>
                        <td>自強</td>
